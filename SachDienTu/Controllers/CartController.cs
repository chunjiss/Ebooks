...
namespace SachDienTu.Controllers
{
    ...
    public class CartController : Controller 
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.cart = cart;
            ViewBag.SiteName = "Thư viện của bạn";
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    foreach (var item in cart.List)
                    {
                        ...
                        invoiceDetailStrBuliders.Append($"Giá thuê: {item.book.price.ToString("#, ##0 VNĐ")}; ");
                    ...
                    identityMessage.Subject = "Xác nhận sách đã thuê";

                    StringBuilder emailStrBuilder = new StringBuilder("HÓA ĐƠN THUÊ SÁCH ĐIỆN TỬ\n\n");
                    ...
                    ViewBag.SiteName = "Thuê sách thành công";
                    return View("OrderSuccess", invoice);
                }
                ViewBag.SiteName = "Thuê";
                return View();
            }
            catch (Exception ex)
            {
                TempData["LoiDatHang"] = "Đặt thuê không thành công.<br>" + ex.Message;
                return RedirectToAction("Index");
            }
        }
